    ...
    <DashboardLayout navItems={navItems} title="Atlas">
      <div className="space-y-5">
        ...
        <div className="flex items-center justify-between">
          ...
          {unreadCount > 0 && (
            <Button variant="outline" onClick={markAllAsRead} className="h-9 text-[13px]">
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1">
                    <p className={`text-[13px] font-medium ${!notification.read ? 'text-primary' : ''}`}>
                      {notification.title}
                    </p>
                  ...
                  <div className="flex items-center gap-2">
                    {notification.donor_id && (
                      <Link to={`/admin/donors/${notification.donor_id}`}>
